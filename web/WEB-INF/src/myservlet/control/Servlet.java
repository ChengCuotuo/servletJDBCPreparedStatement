...
public class Servlet extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String url = "jdbc:mysql://172.0.0.1:3306/" + dataBase
                    + "?user=root&password=021191&characterEncoding=utf-8";
            conn = DriverManager.getConnection(url);
            String condition = "update produce set name=?, price=?, madeTime=?, where number=?";
            ...
            sql = conn.prepareStatement("select * from produce");
            rs = sql.executeQuery();
